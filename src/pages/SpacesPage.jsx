        ...
        <div className="animate-fade-in">
            ...
            <div className="card p-4 mb-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                    ...
                    <select
                        value={filters.capacity} onChange={setFilter('capacity')}
                        className="input-field text-xs"
                        aria-label="Filtrar por capacidad mÃ­nima"
                    >
                    ...
                    <select
                        value={filters.building} onChange={setFilter('building')}
                        className="input-field text-xs"
                    ...
                    <select
                        value={filters.resource} onChange={setFilter('resource')}
                        className="input-field text-xs"
                        aria-label="Filtrar por recurso disponible"
                    >
